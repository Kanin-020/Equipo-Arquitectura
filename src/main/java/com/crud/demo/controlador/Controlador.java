...
/**
 * Se encarga de desplegar todos los usuarios
 * registrados en la vista de la tabla. 
...
/**
 * Se encarga de abrir un formulario en el que
 * se podrán meter los datos de los usuarios.
 * @param modelo Objeto de tipo Model del cual se obtienen los métodos.
 * @return Dirección url
 */
    @GetMapping("/new")
 ...
 * @param usuario Objeto de tipo Usuario el cual contiene
...
/**
 * Se encarga de desplegar un formulario para
...
/**
 * Se encarga de llamar al método para borrar
...
/**
 * Se encarga de llamar al método para
 * borrar varios elementos dentro de la lógica de la aplicación.
 * @param lista Objeto de tipo List donde se guardan los id de varios usuarios.
 * @param modelo Objeto de tipo Model del cual se obtienen los métodos.
 * @return Dirección url.
 */
